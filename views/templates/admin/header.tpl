...
<div class="panel row">
    <h3><i class="icon icon-smile"></i> {l s='Ever Captcha' mod='everpscaptcha'}</h3>
    <div class="col-md-6">
    ...
    <div class="col-md-6">
        <p class="alert alert-warning">
            {l s='This module is free and will always be ! You can support our free modules by making a donation by clicking the button below' mod='everpscaptcha'}
        </p>
        ...
        <input type="image" src="https://www.team-ever.com/wp-content/uploads/2019/06/appel_a_dons-1.jpg" border="0" name="submit" title="PayPal - The safer, easier way to pay online!" alt="Bouton Faites un don avec PayPal" style="max-width: 150px;" />
